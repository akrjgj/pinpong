...
class Board(pygame.Rect):
    def __init__(self, x, y, width, height, speed= setting_board["SPEED"], color= (20, 200, 50), name= None):
...
class Ball():
    def __init__(self, x, y, radius, color = (100, 200, 60), speed = setting_ball["SPEED"]):
        self.X = x
        self.Y = y
        self.RADIUS = radius     
        self.COLOR = color    
